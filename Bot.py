...
def add_server_time(server_url="https://hub.weirdhost.xyz/server/b047251a"):
    """
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            # --- 核心操作：查找并点击 "연장하기" 按钮 ---
            add_button_selector = 'button:has-text("연장하기")' # 已更新为新的按钮文本
            ...
            try:
                ...
                print(f"错误: 在30秒内未找到或 '연장하기' 按钮不可见/不可点击。")
